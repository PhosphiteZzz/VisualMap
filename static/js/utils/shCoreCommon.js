...
dp.sh.Toolbar.Create = function(highlighter)
{
    ...
    if(window.clipboardData) {
        ...
        var code = highlighter.originalCode.replace(/&lt;/g,'<').replace(/&gt;/g,'>').replace(/&amp;/g,'&');
        div.innerHTML += '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"> <embed wmode="transparent" src="' + dp.sh.config.clipboardSwf + '" width="14" height="15" flashvars="clipboard='+encodeURIComponent(code)+'" quality="high" allowScriptAccess="always" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"/></object>';
    }
    return div;
}
